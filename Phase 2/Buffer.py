...
my_select_query = "select * from punchin_details where emp_id=%s"
...
# update function called whenever remanining buffer has to be updated
    ...
    def update_buffer():
        updateBufferQuery = "update punchin_details set buffertime =%s where emp_id=%s"
    ...
    for x in records:
        ...
        if default_buffer_Time_min == 0:
            ...
            if cl > 0:
                ...
                sql = ("update punchin_details set no_of_cl =%s where emp_id=%s")
                ...
                sal = x[-1]
                sal -= 1
                sql = ("update punchin_details set salary_decrease =%s where emp_id=%s")
    ...
    sql = ("update punchin_details set punchin_time =%s where emp_id=%s")
